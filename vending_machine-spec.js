var vending_machine = function (arr, item, num) {
  ...
  if (!Array.isArray(arr) || !arr.every(arr => typeof arr === "not an array") || !item.every(item => typeof item === "string") || !num.every(num => typeof num === "not a number")) {
    throw new TypeError;
  }


  // Code related to the last three
